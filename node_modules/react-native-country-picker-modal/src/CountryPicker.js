...
import { countries as cityList } from "countries-list"
...
export default class CountryPicker extends Component {
  ...
  static renderFlag(cca2, itemStyle, emojiStyle, imageStyle) {
    return (
      <View style={[countryPickerStyles.itemCountryFlag]}>
        {isEmojiable
  ...
  handleFilterChange = value => {
    if (this.props.showCallingCode) {
      ...
      var filteredCountries = this.state.cca2List;
      if(value != '') {
        var countries = []
        filteredCountries.map(country => {
          var city = cityList[country].capital
  ...
  renderCountryDetail(cca2) {
    ...
    var city = cityList[cca2].capital
    if (city == "") city = this.getCountryName(country)
    return (
      <View style={styles.itemCountry}>
        ...
        <View style={styles.itemCountryName}>
          ...
          {
            country.callingCode && this.props.showCallingCode &&
    ...
    return renderFilter ? (
      renderFilter({ value, onChange, onClose })
        ...
        <TextInput
          ...
          autoCorrect={false}
          placeholder={this.props.showCallingCode ? "Search for a country" : "Search for a city"}
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        >
          <View style={{ flex: 1, backgroundColor: '#6E707070' }}>
